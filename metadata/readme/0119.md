...
<!-- ![Banner Image](https://raw.githubusercontent.com/RandomCoderOrg/ubuntu-on-android/modified/assets/banner.jpg "A Image on Ubuntu-on-android running mate desktop on smartphone") -->

<h2 align="Center">Ubuntu on android</h2>

ubuntu-on-android is yet another utility allowing you to install pre-configured ubuntu with gui, development tools, and software on top of android without root via PRoot and Termux. Check the [disclaimer](https://raw.githubusercontent.com/RandomCoderOrg/ubuntu-on-android/modified/md/desclaimer.md) before starting. 
...
Before you install, please read the [wiki](https://udroid-rc.gitbook.io/) and [disclaimer](https://raw.githubusercontent.com/RandomCoderOrg/ubuntu-on-android/modified/md/desclaimer.md). To install stable release of `udroid` filesystem run
...
**->** `jammy:xfce4`
![udroid xfce4](https://raw.githubusercontent.com/RandomCoderOrg/ubuntu-on-android/modified/assets/jammy_xfce4.png)
**->** `jammy:mate`
...
Check [more.](https://raw.githubusercontent.com/RandomCoderOrg/ubuntu-on-android/modified/md/showcase.md)
