...
Some edge-cases examples are available on the `examples` folder. You can read more there [examples/README.md](https://raw.githubusercontent.com/1tayH/noisy/master/examples/README.md).
...
This project is licensed under the GNU GPLv3 License - see the [LICENSE.md](https://raw.githubusercontent.com/1tayH/noisy/master/LICENSE.md) file for details
