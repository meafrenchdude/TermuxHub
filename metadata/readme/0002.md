...
![Findomain](https://raw.githubusercontent.com/Findomain/Findomain/master/images/findomain.png)
...
* Subdomains monitoring: put data to Discord, Slack or Telegram webhooks.  See [Subdomains Monitoring](https://raw.githubusercontent.com/Findomain/Findomain/master/README.md#subdomains-monitoring) for more information.
...
* Hability to query directly the Findomain database created with [Subdomains Monitoring](https://raw.githubusercontent.com/Findomain/Findomain/master/docs/INSTALLATION.md#subdomains-monitoring) for previous discovered subdomains.
* Hability to import and work data discovered by other tools.
* Quiet mode to run it silently.
* Cross platform support: Any platform, it's written in Rust and Rust is multiplatform. See [the documentation](https://raw.githubusercontent.com/Findomain/Findomain/master/docs/INSTALLATION.md#build-for-32-bits-or-another-platform) for instructions.
...
APIs marked with `**`, **require** an access token to work. Search in the [Findomain documentation](https://raw.githubusercontent.com/Findomain/Findomain/master/docs/INSTALLATION.md#access-tokens-configuration) for help on how to configure and use it.

APIs marked with `*` can *optionally* be used with an access token. Create one if you start experiencing problems with that API. Search in the [Findomain documentation](https://raw.githubusercontent.com/Findomain/Findomain/master/docs/INSTALLATION.md#access-tokens-configuration) for help on how to configure and use it.
...
* [Linux](https://raw.githubusercontent.com/Findomain/Findomain/master/docs/INSTALLATION.md#installation-in-linux-using-compiled-artifacts)
* [Windows](https://raw.githubusercontent.com/Findomain/Findomain/master/docs/INSTALLATION.md#installation-windows)
* [MacOS](https://raw.githubusercontent.com/Findomain/Findomain/master/docs/INSTALLATION.md#installation-macos)
* [Aarch64 (Raspberry Pi)](https://raw.githubusercontent.com/Findomain/Findomain/master/docs/INSTALLATION.md#installation-aarch64-raspberry-pi)
* [NixOS](https://raw.githubusercontent.com/Findomain/Findomain/master/docs/INSTALLATION.md#installation-nixos)
* [Docker](https://raw.githubusercontent.com/Findomain/Findomain/master/docs/INSTALLATION.md#installation-docker)
