...
<p align="center">
	...
	<a href="https://kali.download/nethunter-images/kali-2025.4/rootfs">
		<img
...
You will be logged in with the default username, **kali**
...
[Launch](https://raw.githubusercontent.com/jorexdeveloper/termux-nethunter/main/#how-to-launch "View this section.") the system and execute the following commands.
...
Now all that's left is to log in to your newly installed system and start playing around with some commands. To do that, you need to start a VNC server in Kali Nethunter and connect to it through a VNC viewer.

### How to Start the Desktop

[Launch](https://raw.githubusercontent.com/jorexdeveloper/termux-nethunter/main/#how-to-launch "View this section.") the system and execute the following command.
...
1. [Start the desktop](https://raw.githubusercontent.com/jorexdeveloper/termux-nethunter/main/#how-to-start-the-desktop "View this section.") and **minimize** Termux.
...
2. Open the VNC viewer app, click add server, and fill in the following details:
   ...
   - **Password**
     ...
     Enter the **VNC password** you set when [starting the desktop](https://raw.githubusercontent.com/jorexdeveloper/termux-nethunter/main/#how-to-start-the-desktop "View this section.") for the first time.
...
>
> You can [rename](https://raw.githubusercontent.com/jorexdeveloper/termux-nethunter/main/#how-to-rename "View this section") it afterwards.
