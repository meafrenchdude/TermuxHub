...
Thank you for making this project work better and please contribute 🔆  [Contributors](https://raw.githubusercontent.com/SDRausty/TermuxArch/master/CONTRIBUTORS.md) and [Notice to Contributors](https://raw.githubusercontent.com/SDRausty/TermuxArch/master/NOTICE.md) have more information about this project.
...
Install Arch Linux into a Termux PRoot container with [`bash setupTermuxArch`](https://raw.githubusercontent.com/SDRausty/TermuxArch/master/setupTermuxArch).  After succesfull installation start the container with `startarch`.
